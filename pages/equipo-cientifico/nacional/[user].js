...
import {listTeamNacional} from '../../../src/components/shared/equipoCientifico/nacional/listaJson/lista.team.modal';
                                        ...
                                        <div className='footer mt-10 mr-auto'>
                                            <div className='flex flex-wrap redes gap-2'>
                                                <div className='flex items-center gap-2 bg-gray-200 py-2 px-4 cursor-pointer rounded-md'>
                                                    ...
                                                    <a href={item.correo} className='text-color'><h1>{item.email}</h1></a>
                                                </div>
                                                ...
                                                <a href={item.ctvitae} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.ctvitae === null?'hidden':'block'} `}><h1>CTI Vitae</h1></a>
