import { listaPatentes } from "../lista/lista";
                ...
                <div className='flex flex-wrap justify-start gap-2 lg:gap-4'>
                    {
                        listaPatentes.map((item)=>{
                            return <div key={item.id} className='flex flex-col justify-between border-color rounded-md width-perfil p-4'>
                                ...
                                <div className='mt-5'>
                                    <h1 className='text-sm text-gray-700 text-color'><span className="font-bold">Expediente:</span> {item.expediente}</h1>
