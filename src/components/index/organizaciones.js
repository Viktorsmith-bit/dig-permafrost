...
export default function Organizaciones(){
    return(
        <div className='flex' id='organizaciones'>
            <div className='flex flex-1 justify-center items-center py-10 px-4 lg:px-0' style={{backgroundColor:'#5b5b5f'}}>
                <div className='flex-1 w-full md:max-w-2xl lg:max-w-2xl'>
                    ...
                    <div className='flex flex-wrap items-center justify-center mt-5'>
                        <img className='w-48 md:w-56 lg:w-56' src='/logos/organizaciones/INAIGEMBN.svg'/>
                    </div>
                    ...
                    <div className='flex flex-wrap items-center justify-center mt-5 gap-10'>
                        <img className='w-14 md:w-16 lg:w-16' src='/logos/organizaciones/Logo-UNASAM.svg'/>
                        <img className='w-16 md:w-20 lg:w-20' src='/logos/organizaciones/Uni-logo_transparente_granate.svg'/>
                    </div>
                    ...
                    <div className='flex flex-wrap items-center justify-center'>
                        ...
                        <img className='w-24 md:w-32 lg:w-32' src='/logos/organizaciones/university-of-huddersfield-logo.svg'/>
                    </div>
                    ...
                    <div className='flex flex-wrap items-center justify-center mt-5 gap-5'>
                        <img className='w-32 md:w-36 lg:w-40' src='/logos/organizaciones/Logo_USMB_web_grand_RVB.svg'/>
                        <img className='w-16 md:w-16 lg:w-20' src='/logos/organizaciones/IICMLogo_Sf_monoinv.png'/>
                        <img className='w-16 md:w-16 lg:w-20' src='/logos/organizaciones/CCSHLogo_Sf_monoinv.png'/>
                    </div>
                </div>
            </div>
