...
function Lagunas_Huaytapallana(){
    const [state, setState] = useState();
    useEffect(()=>{
        async function PromiseDB(){
            const starCountRef = ref(app, "lagunas_huaytapallana");
    ...
    const OptionsGlaciaresLagunas = {color:"#499285"}
        ...
        return (
            <Fragment>
                <p>
                    ...
                    <br></br>
                    <span className='font-bold'>Número:</span> {feature.properties.Num}
                    <br></br>
...
export default React.memo(Lagunas_Huaytapallana);